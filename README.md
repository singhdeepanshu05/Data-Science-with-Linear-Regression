# Data-Science with Linear Regression
A linear regression model to predict output using sklearn, matplotloib and seaborn.

# Simple Linear Regression Project 


## Modelling the linear relationship between Experience Level,employment type and Salary
...
In this project, I build a Simple Linear Regression model to study the linear relationship between various factors that may affect the salary of an individual. I discuss the basics of linear regression and its implementation in Python programming language using Scikit-learn. Scikit-learn is the popular machine learning library of Python programming language. 
...
As described earlier, the problem is to model and investigate the linear relationship for predicting salary. I have used three performance metrics RMSE (Root Mean Square Value), R2 Score andAdjusted R2 Score value to compute our model performance.
...
In this project, there are various independent or input variable which represents the employment status, employment type, work year etc and is denoted by X. Similarly, there is one dependent or output variable which represents the Salary data and is denoted by y. We want to build a linear relationship between these variables. This linear relationship can be modelled by mathematical equation of the form:-
...
As I have described earlier, the independent and dependent data are given by X and y respectively. If we draw a scatter plot between one of independent value 'salary'  X and 'salary' y, then it resembles the diagram which looks like as follows:-

&nbsp; &nbsp; &nbsp; &nbsp;

![image](https://user-images.githubusercontent.com/62066175/196374316-8fbe5021-b44b-4e12-a085-42aec7a4692b.png)
